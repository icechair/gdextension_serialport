...
void
PortConfig::set_bits(const int bits)
{
  sp_set_config_bits(_ptr, bits);
}

void
PortConfig::set_parity(const sp_parity parity)
{
...
void
PortConfig::set_stopbits(const int stopbits)
{
  sp_set_config_stopbits(_ptr, stopbits);
}

int
PortConfig::get_stopbits() const
{
  int stopbits;
...
void
PortConfig::set_rts(const sp_rts rts)
{
...
void
PortConfig::set_cts(const sp_cts cts)
{
...
void
PortConfig::set_dtr(const sp_dtr dtr)
{
...
void
PortConfig::set_dsr(const sp_dsr dsr)
{
...
void
PortConfig::set_xonxoff(const sp_xonxoff xonxoff)
{
...
void
PortConfig::set_flowcontrol(const sp_flowcontrol flowcontrol)
{
